...
h5disp('train.h5')
trainData = h5read('train.h5','/Spectra/001');
wavelengths = h5read('train.h5','/Wavelengths/1');
trainClass = h5read('train.h5','/Class/1');
...
for i = 1:(100-1)
sequence = [2:100];
temp_trainData = h5read('train.h5',sprintf('/Spectra/%03d',sequence(i)));
...
trainClass = redClass;
testData = h5read('test.h5','/UNKNOWN/1');
temp_testData = h5read('test.h5','/UNKNOWN/2');
